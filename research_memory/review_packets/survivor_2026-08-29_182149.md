# Structural Review Packet — survivor
_Generated 2026-08-29T18:21:49.958163 by core/structural_review.py_

## How to use this packet

Paste this entire file into a Claude conversation and ask something like:

> Review this strategy's logic given the attached flags, hypotheses, and lessons. Are there hidden bugs, unintended couplings between code paths, or config/logic changes that could plausibly improve performance? Cite specific line numbers for anything you flag. Do not propose live-trading changes directly -- only research/backtest-testable ideas.
...
Family: range_options_selling
Description: Nifty weekly OTM CE/PE selling on range-bound moves from anchor.

---

## Recent CONCERNING/PROMISING flags for survivor (2)

- **CONCERNING** `strategy_regime=survivor|CE` (16 trades, 12.5% win, net ₹-19,411.82) — 16 trades, 12.5% win rate, net ₹-19,411.82 -- at or below the 20.0% concerning threshold. _(flagged 2026-08-27T14:18:43.755696)_
- **CONCERNING** `strategy_regime=survivor|PE` (18 trades, 0.0% win, net ₹-24,230.85) — 18 trades, 0.0% win rate, net ₹-24,230.85 -- at or below the 20.0% concerning threshold. _(flagged 2026-08-27T14:18:43.755696)_

---

## Hypotheses referencing survivor (2)

- **[HYP-6dfd0513] TESTING** (LOW confidence, 0 supporting / 0 contradicting experiments): strategy_regime=survivor|PE is a losing condition that should be reduced or avoided, not treated as normal variance.
- **[HYP-2431f8e6] TESTING** (LOW confidence, 0 supporting / 0 contradicting experiments): strategy_regime=survivor|CE is a losing condition that should be reduced or avoided, not treated as normal variance.

---

## lessons.md entries mentioning survivor

(no lessons.md entries currently mention 'survivor')
...
## Full source — strategy/survivor.py
